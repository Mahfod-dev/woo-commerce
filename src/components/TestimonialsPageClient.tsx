				...
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
					<motion.div
						...
						<p className='text-xl text-gray-600 mb-10'>
							Découvrez les expériences authentiques de nos
							clients et pourquoi ils continuent à nous faire
							confiance.
						</p>
					</motion.div>
				</div>
				...
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
					<motion.div
						...
						<p className='text-lg text-gray-600 max-w-2xl mx-auto'>
							Nous sommes fiers de la satisfaction de nos clients
							et des relations durables que nous avons construites
							au fil des années.
						</p>
					</motion.div>
							...
							<motion.div
								...
								<div className='p-6'>
									<div className='flex items-center mb-4'>
										...
										<div>
											<h3 className='font-bold text-gray-900 testimonial-author'>
												{testimonial.author}
											</h3>
									...
									<p className='text-gray-700 italic mb-4 testimonial-quote'>
										"{testimonial.text}"
									</p>
								</div>
							</motion.div>
					...
					<div className='md:flex md:items-center md:space-x-12'>
						<motion.div
							...
							<p className='text-lg text-gray-600 mb-6'>
								Nous valorisons l'honnêteté et la transparence.
								Tous les avis présentés sur notre site sont
							...
							<ul className='space-y-4'>
								<li className='flex items-start'>
									...
									<span className='text-gray-600'>
										Nous envoyons automatiquement une
										demande d'avis après chaque achat
									</span>
								</li>
								<li className='flex items-start'>
									<svg
									...
									<span className='text-gray-600'>
										Chaque avis est vérifié pour confirmer
										qu'il vient d'un client réel
									</span>
								</li>
								<li className='flex items-start'>
									<svg
									...
									<span className='text-gray-600'>
										Nous publions tous les avis, positifs
										comme négatifs, pour une transparence
										totale
									</span>
								</li>
							</ul>
								...
								<div className='absolute inset-0 bg-gradient-to-t from-black/60 to-transparent flex items-end'>
									<div className='p-6'>
										<p className='text-white text-xl font-medium'>
											Votre avis compte pour nous et aide
											d'autres clients à faire des choix
											éclairés
										</p>
									</div>
								</div>
				...
				<div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center'>
					<motion.div
						...
						<p className='text-lg text-indigo-100 mb-8'>
							Votre avis est important et aide d'autres clients à
							faire le bon choix. Partagez votre expérience avec
							nos produits et services.
						</p>
						<Link
							href='/contact'
							className='inline-block bg-white text-indigo-600 font-medium px-8 py-4 rounded-full shadow-lg hover:bg-indigo-50 transition duration-300 cta-button'>
							Laisser un avis
						</Link>
					</motion.div>
				</div>
