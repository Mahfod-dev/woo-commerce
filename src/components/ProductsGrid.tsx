...
export default function ProductsGrid({
  ...
  // Filter products if a limit is specified
  const displayProducts = limit ? products.slice(0, limit) : products;

  // Intersection observer to load products when they are visible
  useEffect(() => {
      ...
      (entries) => {
        entries.forEach((entry) => {
          if (entry.isIntersecting) {
            // Progressive loading for animation effect
  ...
  // Set number of columns based on the property
  const gridCols = {
  ...
  // Animation variants for containers and products
  ...
  // Handle adding to cart with CartProvider
  ...
  return (
    <>
      {/* Notification that appears when adding to cart */}
      <AnimatePresence>
      ...
      <motion.div
        ...
        className={`grid ${gridCols} gap-6 product-grid`}>
          ...
          <motion.div
            ...
            <Link
              ...
              <div className='relative aspect-square overflow-hidden bg-gray-100'>
                ...
                {/* Price and quick button that appear on hover */}
