...
const OrderDetails: React.FC<OrderDetailsProps> = ({ orderId }) => {
  ...
  const handleReorder = async () => {
    try {
      ...
      addNotification({
        type: 'info',
        message: 'Reordering items from your previous order...',
        duration: 3000,
      });
  ...
  const handleCancelOrder = async () => {
    try {
      ...
      if (window.confirm('Are you sure you want to cancel this order? This action cannot be undone.')) {
        addNotification({
          type: 'info',
          message: 'Processing order cancellation...',
          duration: 3000,
        });
            ...
            <motion.div variants={itemVariants} className="bg-white rounded-lg shadow-sm overflow-hidden mb-8">
              ...
              <div className="p-6">
                ...
                <div className="text-sm text-gray-600 mb-4">
                  <p>Your order is currently being processed. You'll receive a shipping confirmation and tracking number once your order ships.</p>
                </div>
              ...
              <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                ...
                <div className="p-6 space-y-4">
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="text-sm text-gray-900">{shipping === 0 ? 'Free' : formatPrice(shipping)}</span>
                  </div>
                  ...
                  <li>
                    <div className="relative pb-8">
                      ...
                      <div className="relative flex space-x-3">
                        ...
                        <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                          <div>
                            <p className="text-sm text-gray-500">Payment {orderStatus.paid ? 'confirmed' : 'pending'}</p>
                          </div>
                          <div className="text-right text-sm whitespace-nowrap text-gray-500">
                            {orderStatus.paid ? formatDate(order.date_modified) : 'Pending'}
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="relative pb-8">
                      ...
                      <div className="relative flex space-x-3">
                        ...
                        <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                          ...
                          <div className="text-right text-sm whitespace-nowrap text-gray-500">
                            {orderStatus.processing ? 'In progress' : 'Pending'}
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="relative pb-8">
                      ...
                      <div className="relative flex space-x-3">
                        ...
                        <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                          ...
                          <div className="text-right text-sm whitespace-nowrap text-gray-500">
                            {orderStatus.shipped ? formatDate(new Date().toISOString()) : 'Pending'}
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="relative">
                      <div className="relative flex space-x-3">
                        ...
                        <div className="min-w-0 flex-1 pt-1.5 flex justify-between space-x-4">
                          ...
                          <div className="text-right text-sm whitespace-nowrap text-gray-500">
                            {orderStatus.delivered ? formatDate(new Date().toISOString()) : 'Pending'}
                          </div>
                        </div>
                      </div>
                    </div>
